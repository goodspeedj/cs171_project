...
topojson = function() {
    function t(t, e) {
        ...
        e.forEach(function(t) {
            ...
            else if (e = o[s]) if (delete o[e.start], e.unshift(t), e.start = c, r = a[c]) {
                delete a[r.end];
            ...
            else if (e = o[c]) if (delete o[e.start], e.unshift(~t), e.start = s, r = a[s]) {
                delete a[r.end];
                var f = r === e ? e : r.concat(e);
                o[f.start = r.start] = a[f.end = e.end] = f
            } else if (r = o[s]) {
            ...
            else if (e = a[s]) if (delete a[e.end], e.push(~t), e.end = c, r = a[c]) {
                delete o[r.start];
                var u = r === e ? e : e.concat(r);
                o[u.start = e.start] = a[u.end = r.end] = u
            } else if (r = o[c]) {
